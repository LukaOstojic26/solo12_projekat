...
class LQR():
    ...
    def compute_control(self, ref_position,  ref_velocity, position, velocity, sensors):
        ...
        q1_1 = np.pi/2 + beta - position[1]

        q1_2 = position[1] + (np.pi/2)

        q2_1 = np.pi/2 + beta - position[4]
        ...
        controlLQR = np.array([0, controlLQR1 + controlPD_sym1, 0, 0, controlLQR2 + controlPD_sym2, 0, 0, 0, 0, 0, 0, 0])

        ########################################################
        #self.i += 1
#
        #x_val.append(self.i)
        #y_val.append(controlLQR1)
        #plt.xlim(0, 3000)
        #plt.ylim(-20, 20)
